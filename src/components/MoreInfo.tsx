...
export default function MoreInfo() {
    return (
        <section className="relative z-20 bg-[#050505] text-[#ededed] min-h-screen py-24 px-6 md:px-20 selection:bg-[#CC0000] selection:text-black">
            <div className="max-w-7xl mx-auto">

                {/* -- HERO / INTRO -- */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-32 border-b border-white/10 pb-20">
                    <div>
                        <h2 className="text-4xl md:text-6xl font-serif mb-8 text-[#CC0000]">
                            The Alchemy of Time
                        </h2>
                    ...
                    <div className="relative h-full min-h-[400px] w-full bg-[#111] border border-white/5 overflow-hidden group">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black/90 to-transparent">
                            <h3 className="text-xl font-serif text-[#CC0000] mb-2">Simplicity & Lightness</h3>
                ...
                <div className="mb-32">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-gray-400">
                        <div className="relative pl-8 border-l border-white/10 group hover:border-[#CC0000] transition-colors duration-500">
                            <span className="absolute -left-3 top-0 text-[#CC0000] text-xl bg-[#050505] py-1">I.</span>
                            <h3 className="text-white font-serif text-xl mb-3 group-hover:text-[#CC0000] transition-colors">The Zonda (1999)</h3>
                        ...
                        <div className="relative pl-8 border-l border-white/10 group hover:border-[#CC0000] transition-colors duration-500">
                            <span className="absolute -left-3 top-0 text-[#CC0000] text-xl bg-[#050505] py-1">II.</span>
                            <h3 className="text-white font-serif text-xl mb-3 group-hover:text-[#CC0000] transition-colors">The Huayra (2011)</h3>
                            <p className="text-sm leading-relaxed">
                        ...
                        <div className="relative pl-8 border-l border-[#CC0000] group">
                            <span className="absolute -left-3 top-0 text-[#CC0000] text-xl bg-[#050505] py-1">III.</span>
                            <h3 className="text-[#CC0000] font-serif text-xl mb-3">The Utopia (2022)</h3>
                ...
                {/* -- TECHNICAL SPECS -- */}
                <div className="mb-32">
                    <h2 className="text-4xl md:text-5xl font-serif text-center text-[#CC0000] mb-16">Engineering Masterpiece</h2>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {/* Spec 1 */}
                        <div className="bg-white/5 border border-white/10 p-8 hover:border-[#CC0000]/50 transition-colors duration-500 hover:-translate-y-2 transform">
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="border border-white/10 p-6 flex items-start gap-4 hover:bg-white/5 transition-colors duration-500">
                            <div className="text-[#CC0000] text-2xl">⚙</div>
                            <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="h-[400px] bg-[#0a0a0a] border border-white/10 flex items-center justify-center group overflow-hidden relative cursor-pointer">
                        ...
                        <div className="absolute bottom-6 left-6 z-10">
                            <span className="text-white/80 uppercase tracking-widest text-sm border-b border-[#CC0000] pb-1">Rear Profile</span>
                        </div>
                    </div>
                    ...
                    <div className="h-[400px] bg-[#0a0a0a] border border-white/10 flex items-center justify-center group overflow-hidden relative cursor-pointer">
                        ...
                        <div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors duration-500"></div>
                        <div className="absolute bottom-6 left-6 z-10">
                            <span className="text-white/80 uppercase tracking-widest text-sm border-b border-[#CC0000] pb-1">Design Details</span>
                        </div>
                    </div>
                </div>
